...
import { AgentPerformanceByYearComponent } from './reports/agent-performance/reports/agent-performance/agent-performance-by-year/agent-performance-by-year.component';
...
export const salesReportRoutes: Routes = [
  ...
  { path: 'sales-by-salesperson', component: SalesBySalespersonComponent }
];

// --- Agent Performance (children) ---
export const agentPerformanceRoutes: Routes = [
  { path: '', redirectTo: 'agent-performance-by-year', pathMatch: 'full' }, // default child
  { path: 'agent-performance-by-year', component: AgentPerformanceByYearComponent },
...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'user-management', component: UserManagementComponent, children: userManagementRoutes },
      { path: 'reports/sales', component: SalesComponent, children: salesReportRoutes },
      { path: 'reports/agent-performance', component: AgentPerformanceComponent, children: agentPerformanceRoutes },
      { path: 'reports/customer-feedback', component: CustomerFeedbackComponent, children: customerFeedbackRoutes }
    ]
  },
